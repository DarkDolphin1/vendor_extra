...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/extra/themes/fonts/prebuilt,$(TARGET_COPY_OUT_PRODUCT)/fonts) \
    vendor/extra/themes/fonts/config/fonts_customization.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/fonts_customization.xml
